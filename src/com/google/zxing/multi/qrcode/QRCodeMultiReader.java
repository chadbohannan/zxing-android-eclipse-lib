...
public final class QRCodeMultiReader extends QRCodeReader implements MultipleBarcodeReader {
  ...
  private static final class SAComparator implements Comparator<Result>, Serializable {
    ...
    public int compare(Result a, Result b) {
      int aNumber = (int) (Integer) (a.getResultMetadata().get(ResultMetadataType.STRUCTURED_APPEND_SEQUENCE));
      int bNumber = (int) (Integer) (b.getResultMetadata().get(ResultMetadataType.STRUCTURED_APPEND_SEQUENCE));
      if (aNumber < bNumber) {
        return -1;
      }
      if (aNumber > bNumber) {
